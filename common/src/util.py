...
BadRead.allheaders = map(lambda cls: cls[1].header,inspect.getmembers(sys.modules[__name__], lambda member: inspect.isclass(member) and issubclass(member,BadRead) and member != BadRead))
