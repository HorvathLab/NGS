...
if GUI() and len(sys.argv) == 1:
    ...
    parser = OptionParserGUI(version=VERSION_SNPlice)
    error_kwargs = {'exit': False}
else:
    parser = OptionParser(version=VERSION_SNPlice)
    error_kwargs = {}
...
for snpchr,snppos,ref,alt,snpextra in snpdata:
	...
	if opt.unique:
        ...
        #     continue
        spliced = 'SPLICED'; notspliced = 'NOTSPLICED';
        other = 'OTHER'; all = 'ALL'; mates = 'MATES'; notmates = 'NOTMATES'
